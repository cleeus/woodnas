...
function wn_hdd_carrier_d() = wn_hdd_slot_w() + 20;

function wn_fan_d() = 25.5;
function wn_fan_r() = 120/2;

function wn_fan_box_d() = wn_fan_d() + 15 /*buffer*/;
function wn_fan_box_w() = wn_case_w() - 4*wn_wall_d();
function wn_fan_box_h() = 4*wn_hdd_slot_h() + 2*wn_wall_d();
